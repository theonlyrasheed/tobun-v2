      ...
      <Box className='about-grid'>
        <Box className='about-portrait' data-reveal>
          <Box
            className='frame'
            data-cursor='view'
            data-cursor-label='Meet Lateefat'
          >
            <Box
              component='img'
        ...
        <Box data-reveal>
          ...
          <Text
            component='h2'
            className='h-lg font-medium!'
            style={{ margin: "18px 0 22px" }}
          >
            My heart chose <em className='accent-ochre'>art</em> — and art chose
            transformation.
          </Text>
          <Box
            className='flow lead'
            style={{ color: "var(--fg-soft)", fontWeight: "500" }}
          >
            <Text component='p'>
              I'm Lateefat Modupeola Tobun, a multidisciplinary visual artist
              and digital couturier. My practice explores the boundary between
              physical creativity and the global digital world — where tradition
              meets innovation.
            </Text>
            <Text component='p'>
              ...
              colour, charcoal and ADIRE indigo — using fabric as both medium
              and message.
            </Text>
          </Box>
          <Anchor
