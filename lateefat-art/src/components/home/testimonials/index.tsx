        ...
        <Box component="figure" className="tst">
          ...
          <Box component="figcaption">
            ...
            <Box component="span" className="tst-meta">
              <Text component="span" className="tn">Amara Okafor</Text>
              <Text component="span" className="tr">Workshop participant · Bradford</Text>
            </Box>
          </Box>
        </Box>
        <Box component="figure" className="tst">
          ...
          <Box component="figcaption">
            ...
            <Box component="span" className="tst-meta">
              <Text component="span" className="tn">Daniel Mensah</Text>
              <Text component="span" className="tr">Curator · Accra</Text>
            </Box>
          </Box>
        </Box>
        <Box component="figure" className="tst">
          ...
          <Box component="figcaption">
            ...
            <Box component="span" className="tst-meta">
              <Text component="span" className="tn">Sofia Reyes</Text>
              <Text component="span" className="tr">Creative director · London</Text>
            </Box>
          </Box>
        </Box>
      </Box>
