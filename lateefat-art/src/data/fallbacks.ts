    ...
    answer: [
      {
        ...
        children: [
          {
            _type: "span",
            text: "Yes — I take a limited number of couture, textile, mural and digital commissions each year. Share your idea, timeline and space, and I'll tell you honestly whether it's a fit.",
          },
        ],
      },
    ],
    ...
    answer: [
      {
        ...
        children: [
          {
            _type: "span",
            text: "Absolutely. I run printing workshops, fashion-tech bootcamps and mindful art sessions for schools, companies and communities — in person across the UK and remotely worldwide.",
          },
        ],
      },
    ],
    ...
    answer: [
      {
        ...
        children: [
          {
            _type: "span",
            text: "As a collaborator, never a shortcut. I use AI and data tools to extend hand-made work into sustainable, digital wearable art — the concept, craft and cultural story always lead.",
          },
        ],
      },
    ],
    ...
    answer: [
      {
        ...
        children: [
          {
            _type: "span",
            text: "I'm based in Bradford, United Kingdom, and work internationally. Original pieces and prints ship worldwide; bespoke and large-scale works are arranged case by case.",
          },
        ],
      },
    ],
    ...
    answer: [
      {
        ...
        children: [
          {
            _type: "span",
            text: "It depends on scope — a print can be a couple of weeks, while couture or murals run one to three months. We'll map clear milestones before any work starts.",
          },
        ],
      },
    ],
...
export const fallbackTestimonials: Testimonial[] = [
  {
    ...
    quote:
      "Lateefat turned a room of strangers into makers in an afternoon. People left holding something they made — and a little more of themselves.",
    rating: 5,
  },
  {
    name: "Daniel Mensah",
    ...
    quote:
      "Her work sits exactly where tradition meets technology. The ADIRE indigo feels ancestral and the digital layer feels like tomorrow.",
    rating: 5,
  },
  {
    name: "Sofia Reyes",
    ...
    quote:
      "Collaborating with Lateefat is rare — rigorous about the craft, generous with the vision. She makes the ambitious feel inevitable.",
    rating: 5,
  },
];
...
export const fallbackExhibitions: Exhibition[] = [
  ...
  },
  {
    ...
    record: {
      ...
      paragraphs: [
        "Colors of Clothes brought traditional ADIRE printing methods to life through interactive digital fashion design, examining how cloth is coded with family memories.",
      ],
      gallery: [
        "https://picsum.photos/seed/lt-10-visual-painting/600/600",
        "https://picsum.photos/seed/lt-2-adire-indigo-study/600/600",
